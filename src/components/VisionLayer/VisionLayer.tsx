        ...
        <div className={`${className} ${styles.VisionLayer}`}>
            ...
            <ul className={styles.blocks}>
                <li className={styles.block}>
                    <span className={styles['block-title']}>다양한 데이터셋을 활용한 객체 탐지</span>
                    <ArrowDown className={styles['block-icon']}/>
                </li>
                <li className={styles.block}>
                    <span className={styles['block-title']}>다양한 데이터셋을 활용한 객체 분류</span>
                    <ArrowDown className={styles['block-icon']} />
                </li>
                <li className={styles.block}>
                    <span className={styles['block-title']}>다양한 데이터셋을 활용한 객체 분할</span>
                    <ArrowDown className={styles['block-icon']} />
                </li>
                <li className={styles.block}>
